...
// //
// // class ApiBaseHelper {
// //   final String _baseUrl = "http://api.openweathermap.org/data/2.5/weather?q=London&units=metric&appid=";
// //
...
//
// class ApiBaseHelper {
//   final String _baseUrl = "http://api.weatherapi.com/v1/forecast.json?days=3&q=Lviv&key=";
//
//   Future<dynamic> get(String url) async {
//     print('Api Get, url $url');
//     var responseJson;
